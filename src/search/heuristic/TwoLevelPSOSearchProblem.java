...
public class TwoLevelPSOSearchProblem extends ModelSearchProblem {

	private int cLength;

	private Map<PlateauModelLite, Double> seen;

	public TwoLevelPSOSearchProblem(ExtendedModel extendedModel, OutputSpec outputSpec, List<Dataset> datasets,
		...
		// Real solution will be treated as integer by the decoder by default
