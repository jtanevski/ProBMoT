...
public class WSSE2LObjectiveFunction
	...
	public WSSE2LObjectiveFunction(Dataset measured, BiMap<String, String> outsToCols,BiMap<String,String> weightsToCols) {
		sses = new WSSE2L[outsToCols.size()];
		int i = 0;
		for (String out : outsToCols.keySet()) {
			...
			sses[i] = new WSSE2L(measured.getCol(measured.getColIndex(outsToCols.get(out))),weights);
			i++;
		}
